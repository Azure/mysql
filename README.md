...
Follow the steps to configure the secret:
  ...
  * Also, copy the connection string from Azure MySQL DB which is under **Connection strings > ADO.NET** and of the format: Server={your_server}; Port=3306; Database={your_database}[optional]; Uid={your_user}; Pwd={your_password}; SslMode=Preferred;
